...
<?php include('navbar.php'); ?>
    ...
    <div class="serverTable" style="text-align: center;margin:auto">
        <table style="border-radius: 5px; border-width: 2px">
            <tr>
                <th colspan="4" style="text-align: center"><h1>Aktuelle Server</h1></th>
            </tr>
            <tr>
        ...
        <div id="audioContainer">
            <audio controls="controls" src="https://Fps3.listen2myradio.com:2199/listen.php?ip=109.169.23.124&amp;port=9513&amp;type=s1"></audio>
        </div>
</div>
